...
const modalTypeConfig = {
    success: {
        ...
        color: "text-white rounded-lg bg-success-500 shadow-theme-xs hover:bg-success-600"
    },
    info: {
        icon: (
            <div className="relative flex items-center justify-center z-1 mb-7">
        ...
        color: "text-white rounded-lg bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600"
    },
    warning: {
        icon: (
            <div className="relative flex items-center justify-center z-1 mb-7">
        ...
        color: "text-white rounded-lg bg-warning-500 shadow-theme-xs hover:bg-warning-600"
    },
    error: {
        icon: (
            <div className="relative flex items-center justify-center z-1 mb-7">
        ...
        color: "text-white rounded-lg bg-error-500 shadow-theme-xs hover:bg-error-600"
    },
};

const AlertModal: React.FC<AlertModalProps> = ({type, isOpen, title, message, onClose, btnText}) => {
    const {icon, color} = modalTypeConfig[type];

    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            className="max-w-[540px] p-5 lg:p-10"
        >
            <div className="text-center">
                ...
                <div className="flex items-center justify-center w-full gap-3 mt-7">
                    <button
                        type="button"
                        className={'flex justify-center w-full px-4 py-3 text-sm font-medium ' + color + ' sm:w-auto'}
                    >
                        {btnText}
                    </button>
                </div>
